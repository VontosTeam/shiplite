      ...
      <main className="flex-1">
        ...
        <section className="relative">
          ...
          <div className="absolute inset-0">
            <picture>
              <source srcSet="/images/banners/hero-banner.webp" type="image/webp" />
              <Image
          ...
          <div className="relative z-10 container mx-auto grid gap-8 px-4 py-12 md:grid-cols-2 md:py-24">
            ...
            <div className="flex items-center justify-center">
              <picture>
                <source srcSet="/images/banners/hero-image-1.webp" type="image/webp" />
                <Image
                  src="/images/banners/hero-image-1.jpg"
